...
export default function DesktopLeadForm() {
  ...
  return <div className="desktop-lead" id="pc-inquiry">
    <div className="desktop-lead-copy"><span>전화 상담 신청</span><h3>연락처를 남기시면<br />전화로 상담드립니다.</h3><p>연락받을 번호를 입력하고 ‘상담 신청하기’를 누르시면, 접수 내용을 확인한 뒤 김대곤 대표가 전화드립니다.</p><a href="tel:01091832200">바로 통화하고 싶다면 010-9183-2200</a></div>
    {state === "done" || state === "done-needs-call" ? <div className="desktop-lead-done" role="status"><strong>상담 신청을 받았습니다.</strong><p>{state === "done-needs-call" ? "접수 알림이 지연되고 있어요. 빠른 상담을 원하시면 010-9183-2200으로 직접 전화해주세요." : "접수 내용을 확인해 김대곤 대표에게 전달하겠습니다. 급한 문의는 010-9183-2200으로 전화해주세요."}</p></div> : <form className="desktop-lead-form" onSubmit={submit}>
