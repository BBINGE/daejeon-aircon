export default function TermsPage() {
  return <main className="legal-page">
    ...
    <article className="legal-content">
      ...
      <section className="legal-section"><h2>5. 사업자 정보</h2><table><tbody><tr><th>상호</th><td><span className="placeholder">[대표 확인 필요]</span></td></tr><tr><th>대표자</th><td>김대곤</td></tr><tr><th>사업자등록번호</th><td><span className="placeholder">[대표 확인 필요]</span></td></tr><tr><th>주소</th><td><span className="placeholder">[대표 확인 필요]</span></td></tr><tr><th>대표전화</th><td><a href="tel:01091832200">010-9183-2200</a></td></tr></tbody></table></section>
