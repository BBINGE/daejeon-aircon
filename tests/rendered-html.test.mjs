...
try {
  ...
  for (const image of ['unit-anonymous.webp', 'install-anonymous.webp', 'service-anonymous.webp', 'roof-anonymous.webp', 'work-anonymous.webp']) {
    assert.ok(home.includes(image));
  }
  for (const image of ['/images/install.webp', '/images/service.webp', '/images/roof.webp', '/images/work.webp']) {
    assert.ok(!home.includes(image));
  }
